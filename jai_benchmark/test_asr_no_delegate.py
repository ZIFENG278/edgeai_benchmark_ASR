...
class TestAudio():
    def __init__(self, wav_path, model_path):
        ...
        self.delegate_options = {
            ...
            "artifacts_folder": '/home/zifeng/reclone/r8.2/edgeai-modelzoo/modelartifacts/8bits/cl-1998_tflitert_imagenet1k_mlperf_wake_word_stop_model_complexV3_tflite/artifacts',
            "import": 'no'
        }
...
model_path = '/home/zifeng/reclone/r8.2/edgeai-modelzoo/modelartifacts/8bits/cl-1998_tflitert_imagenet1k_mlperf_wake_word_stop_model_complexV4_tflite/model/wake_word_stop_model_complexV4.tflite'
wav_path = '/home/zifeng/reclone/r8.2/edgeai-benchmark/dependencies/datasets/wavdataset/val/31/learn001.wav'
